...
#define NEUTRINO_RECORDING_TIMER_SCRIPT "/usr/ntrino/scripts/recording.timer"
#define NEUTRINO_RECORDING_START_SCRIPT "/usr/ntrino/scripts/recording.start"
#define NEUTRINO_RECORDING_ENDED_SCRIPT "/usr/ntrino/scripts/recording.end"
#define NEUTRINO_ENTER_STANDBY_SCRIPT   "/usr/ntrino/scripts/standby.on"
#define NEUTRINO_LEAVE_STANDBY_SCRIPT   "/usr/ntrino/scripts/standby.off"
#define NEUTRINO_ENTER_INACTIVITY_SCRIPT	"/usr/ntrino/scripts/inactivity.on"
#define NEUTRINO_ENTER_DEEPSTANDBY_SCRIPT	"/usr/ntrino/scripts/deepstandby.on"
#define NEUTRINO_LEAVE_DEEPSTANDBY_SCRIPT	"/usr/ntrino/scripts/deepstandby.off"
#define MOVIEPLAYER_START_SCRIPT        "/usr/ntrino/scripts/movieplayer.start"
#define MOVIEPLAYER_END_SCRIPT          "/usr/ntrino/scripts/movieplayer.end"
